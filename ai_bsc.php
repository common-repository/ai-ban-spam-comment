   ...
   <?php wp_nonce_field("aibsc","aibsc"); ?>
        ...
        <label class="bsc_label">Models:</label>
             <select  name="abscai_models" class="regular-text">
                  <?php if(esc_attr(get_option('abscai_models'))=='gpt-4o'){
    echo '<option value="gpt-4o" selected>gpt-4o</option>';
     echo '<option value="gpt-4-turbo">gpt-4-turbo</option>'; 
     
 
}
  
  else if(esc_attr(get_option('abscai_models'))=='gpt-4-turbo'){
    echo '<option value="gpt-4-turbo" selected>gpt-4-turbo</option>'; 
